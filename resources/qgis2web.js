...
map.getView().fit([11496381.150533, -7700.187010, 11500612.842297, -4907.696823], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">WEBGIS LOKASI PERKEBUNAN DESA LAHANG HULU </h2>';
        return titleElement;
    })(),
